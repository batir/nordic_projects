...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LOG_SNIFFER_INFO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_GET_ENTROPY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_CTR_DRBG_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_NRF_RNG_ENTROPY_DRIVER, 1);
